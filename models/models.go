...
type UsersUser struct {
	...
	UserEmailPromotion sql.NullInt64         `db:"user_email_promotion" json:"userEmailPromotion"`
	...
	UserCurrentRole    sql.NullInt64         `db:"user_current_role" json:"userCurrentRole"`
}
